...
async function callAI(messages, profile) {
  ...
  if (!apiKey || apiKey === 'your_openai_api_key_here') {
    throw new Error('API key not set. Please add REACT_APP_OPENAI_API_KEY to your .env file.');
  }
    ...
    <div className="screen">
      ...
      <div className="card mt12 anim anim-3">
        ...
        {process.env.REACT_APP_OPENAI_API_KEY && process.env.REACT_APP_OPENAI_API_KEY !== 'your_openai_api_key_here'
          ? <p className="t-sm" style={{ color:'var(--g-mid)' }}>✓ OpenAI GPT-4o is connected and ready.</p>
          : <p className="t-sm c-muted">Add <code>REACT_APP_OPENAI_API_KEY</code> to your <code>.env</code> file to enable AI chat.</p>
        }
      </div>
